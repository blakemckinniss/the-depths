...
import type { GameState, Item, StatusEffect, DungeonKey } from "@/lib/core/game-types"
import type { WorldState } from "@/lib/world/world-state"
import type { ChaosEvent } from "@/lib/world/chaos-system"
import { generateEnemy, generateWeapon, generateArmor, generatePotion } from "@/lib/core/game-data"
...
export function DevPanel({
  ...
  const triggerChaos = useCallback(
    (eventName: string) => {
      ...
      import("@/lib/world/chaos-system").then(({ CHAOS_EVENTS }) => {
