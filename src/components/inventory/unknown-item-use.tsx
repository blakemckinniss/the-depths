...
import type { UnknownItem, Player, SkillCheck } from "@/lib/core/game-types"
import { rollSkillCheck, formatSkillCheck, getDifficultyLabel } from "@/lib/combat/skill-check"
import type { UnknownItemUseResponse } from "@/lib/hooks/use-event-chain"
...
export function UnknownItemUse({ item, player, onUse, onCancel, onResult, isGenerating }: UnknownItemUseProps) {
  ...
  const performSkillCheck = () => {
    ...
    const check = rollSkillCheck(player, pendingResult.skillCheck.skill, pendingResult.skillCheck.difficulty)
