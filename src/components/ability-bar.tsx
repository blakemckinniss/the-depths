...
import type { Player, Ability, Enemy, SustainedAbility } from "@/lib/game-types"
import { canUseAbility, getResourceColor, CLASSES } from "@/lib/ability-system"
import { canActivateSustained, getEffectiveResources, getSustainedDisplayColor } from "@/lib/sustained-ability-system"
...
export function AbilityBar({ player, currentEnemy: _currentEnemy, onUseAbility, onToggleSustained, disabled }: AbilityBarProps) {
