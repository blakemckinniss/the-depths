...
export const itemSchema = z.object({
  ...
  useText: z.string().optional().describe("What happens when used, 1 sentence"),
})
...
export const enemySchema = z.object({
  ...
  weakness: z.string().optional().describe("A hint at vulnerability"),
  lastWords: z.string().optional().describe("What it says/does when dying"),
})
...
export const companionSchema = z.object({
  ...
  betrayalHint: z.string().optional().describe("Subtle warning sign, 1 sentence"),
...
export const roomNarrationSchema = z.object({
  ...
  entityIntro: z.string().optional().describe("How entity in room is introduced, 1 sentence"),
  environmentalDetail: z.string().describe("A small sensory detail, 1 sentence"),
  foreshadowing: z.string().optional().describe("Hint at future danger or reward, 1 sentence"),
})
...
export const eventOutcomeSchema = z.object({
  ...
  foreshadow: z.string().optional().describe("Hint at lasting effect, 1 sentence"),
})
...
export const roomEventEnemySchema = z.object({
  ...
  battleCry: z.string().optional(),
  deathCry: z.string().optional(),
})
...
export const roomEventSchema = z.object({
  ...
  environmentalEntities: z.array(environmentalEntitySchema).optional(),
  enemy: roomEventEnemySchema.optional(),
  loot: roomEventLootSchema.optional(),
  trap: roomEventTrapSchema.optional(),
  shrine: roomEventShrineSchema.optional(),
  npc: roomEventNPCSchema.optional(),
  foreshadow: z.string().optional().describe("Subtle hint at future danger or reward"),
})
...
export const companionRecruitSchema = z.object({
  ...
  fleeThreshold: z.number().optional().describe("HP percentage to flee"),
  bond: z.object({
...
export const companionActionSchema = z.object({
  ...
  moodShift: z.string().optional().describe("New mood"),
})
...
export const enhancedLootSchema = z.object({
  ...
  useHint: z.string().optional().describe("Special property hint"),
})
...
export const environmentalInteractionSchema = z.object({
  ...
  consequences: z.object({
    entityConsumed: z.boolean().optional(),
    spawnsEnemy: z.boolean().optional(),
    triggersTrap: z.boolean().optional(),
    revealsSecret: z.boolean().optional(),
  }).optional(),
  newEntity: environmentalEntitySchema.optional(),
  companionReaction: z.string().optional().describe("What companion says if present"),
})
...
export const unknownItemUseSchema = z.object({
  ...
  immediateEffects: z.object({
    healing: z.number().optional(),
    damage: z.number().optional(),
    damageType: z.enum(["poison", "fire", "ice", "shadow", "holy", "arcane", "physical"]).optional(),
  ...
  itemTransformation: z.object({
    ...
    description: z.string(),
    lore: z.string(),
    useText: z.string().optional(),
    canReuse: z.boolean().optional(),
    stats: z.object({
      attack: z.number().optional(),
      defense: z.number().optional(),
  ...
  companionReaction: z.string().optional(),
  worldReaction: z.string().optional(),
})
...
export const generateEffectSchema = z.object({
  ...
  condition: z.string().optional().describe("Condition for conditional duration"),
  ...
  stackModifier: z.number().optional(),
  modifiers: z.object({
    attack: z.number().optional(),
    defense: z.number().optional(),
    maxHealth: z.number().optional(),
  ...
  tickNarration: z.string().optional().describe("What happens each tick"),
  ...
  cleansable: z.boolean().optional(),
  cleanseResistance: z.number().optional(),
  animation: z.enum(["pulse", "shimmer", "flicker", "burn", "freeze", "poison", "holy", "dark"]).optional(),
  color: z.string().optional().describe("CSS color class"),
})
...
export const ambientEffectSchema = z.object({
  ...
  warning: z.string().optional().describe("Any hint of what's to come"),
  resistanceNarration: z.string().optional().describe("What happens if resisted"),
})
