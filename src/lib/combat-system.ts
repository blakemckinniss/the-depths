import type { Player, Enemy, CombatStance, DamageType, EnemyAbility, ComboTracker, StatusEffect } from "./game-types"
import { calculateEffectiveStats, STATUS_EFFECTS, createStatusEffect } from "./entity-system"
